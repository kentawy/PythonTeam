...
def create_and_write_file(filename):
    try:
        ...
        with open(filename, 'a') as file:
            ...
            file.write(f"Прізвище та ім'я: Гаценко Максим\n")
            file.write(f"Відповідь: За допомогою [::-1] двокрапки визначають що ми беремо весь рядок і крок дії, а -1 визначає напрямок дії, а саме навпаки з кінця в початок\n")
            file.write(f"Наприклад: рядок = 'привіт,світ!'\n перевернутий_рядок = рядок[::-1]\n Результатом буде !тівс ,тівирП\n")
            file.write(f"Питання для наступного студента: Як отримати останній елемент списку в Python?\n")
            
            # П'ятий студент: відповідь та питання
